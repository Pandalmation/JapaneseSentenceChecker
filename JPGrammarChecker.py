...
root.title("Japanese Sentence Checker")
root.configure(bg='#ffcccc')  


# Label for entering Japanese sentence
input_label = tk.Label(root, height=2, width=40, text="Enter Japanese Sentence", bg='#ffcccc', fg='#571d3a')
input_label.pack()
...
parsed_label = tk.Label(root, height=2, width=40, text="Parsed Sentence", bg='#ffcccc', fg='#571d3a')
parsed_label.pack()
